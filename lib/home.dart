 ...
 MediaType mediaType = MediaType.movie;
  ...
  @override
   Widget build(BuildContext context) {
    return new Scaffold(
            appBar: new AppBar(
              title: new Text("CINÉFILO-BTRAVI"),
              actions: <Widget>[
                new IconButton(
       ...
       [
          new BottomNavigationBarItem(icon: new Icon(Icons.thumb_up),
          title: new Text("Populares")
          ),
          new BottomNavigationBarItem(icon: new Icon(Icons.update),
          title: new Text("En el aire")
          ),
          new BottomNavigationBarItem(icon: new Icon(Icons.star),
